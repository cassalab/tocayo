...
df = pd.read_csv("/net/data/aasubs/clinvar_only/pvs1/splice_entries.csv", usecols = ["Chromosome", "Start", "simple_name", "ReferenceAlleleVCF", "AlternateAlleleVCF"], dtype = str)
...
for i in range(19):
	...
	os.system(f"cp /net/data/aasubs/clinvar_only/pvs1/{i}_splice_vep_input.txt /net/data/aasubs/clinvar_only/pvs1/{i}_splice_vep_input.vcf")
	os.system(f"rm /net/data/aasubs/clinvar_only/pvs1/{i}_splice_vep_input.txt")
