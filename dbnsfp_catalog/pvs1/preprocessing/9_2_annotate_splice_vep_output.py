...
def main():
	...
	vepFinalDf = vepDf[(vepDf["CANONICAL"] == "YES") & ((vepDf["Consequence"].str.contains("splice_acceptor_variant")) | (vepDf["Consequence"].str.contains("splice_donor_variant")))].drop_duplicates(subset = ["simple_name"]).reset_index(drop = True)
