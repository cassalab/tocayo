...
for i in range(124):
	files_left.append(f"{i}")

for x in files_left:
	input_path = f"/net/data/aasubs/dbnsfp_catalog/pvs1/{x}_dbn_stop_vep_input.vcf"
	output_path = f"/net/data/aasubs/dbnsfp_catalog/pvs1/{x}_dbn_stop_vep_output.vcf"

	job_path = "/net/data/aasubs/dbnsfp_catalog/vep/jobs/j" + x + "_dbn_stop_vep_lof.sh"
