...
for evidence in evidenceList:
	...
	plpDfOriginal = pd.read_csv(f"/net/data/aasubs/dbnsfp_catalog/classified/dbnsfp_{evidence}_plp_analysis.csv")
	blbDfOriginal = pd.read_csv(f"/net/data/aasubs/dbnsfp_catalog/classified/dbnsfp_{evidence}_blb_analysis.csv")
	...
	plpDf.to_csv(f"/net/data/aasubs/dbnsfp_catalog/unique/dbnsfp_{evidence}_plp_analysis.csv")
	blbDf.to_csv(f"/net/data/aasubs/dbnsfp_catalog/unique/dbnsfp_{evidence}_blb_analysis.csv")
