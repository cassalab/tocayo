...
cvDf = pd.read_csv(f"/net/data/aasubs/dbnsfp_catalog/annotated/moderate_annotated_cv_potential_entries.csv", dtype = str)
dbDf = pd.read_csv(f"/net/data/aasubs/dbnsfp_catalog/annotated/moderate_annotated_db_potential_entries.csv", dtype = str)
...
outDf = combDf[((combDf["cv_impact"] == "MODERATE") | (combDf["cv_impact"] == "HIGH")) & (((combDf["db_impact"] != "MODERATE") & (combDf["db_impact"] != "HIGH")) | (combDf["cv_half_aa"] != combDf["db_half_aa"]) | (combDf["cv_full_aa"] == combDf["db_full_aa"]) | (combDf["cv_protein_position"] != combDf["db_protein_position"]))]
combDf = combDf[((combDf["cv_impact"] == "MODERATE") | (combDf["cv_impact"] == "HIGH")) & ((combDf["db_impact"] == "MODERATE") | (combDf["db_impact"] == "HIGH")) & (combDf["cv_half_aa"] == combDf["db_half_aa"]) & (combDf["cv_full_aa"] != combDf["db_full_aa"]) & (combDf["cv_protein_position"] == combDf["db_protein_position"])]
...
combDf_single.to_csv("/net/data/aasubs/dbnsfp_catalog/filtered/moderate_filtered_potential_entries_single.csv")
...
combDf.to_csv("/net/data/aasubs/dbnsfp_catalog/filtered/moderate_filtered_potential_entries_both.csv")
...
vepDf["Half_acids"] = vepDf["Amino_acids"].str.split("/").str.get(0)
...
vepFinalDf = pd.concat([vepFinalDf, vepDf[(vepDf["CANONICAL"] == "YES") & ((vepDf["IMPACT"] == "MODERATE") | (vepDf["IMPACT"] == "HIGH")) & (vepDf["BIOTYPE"] == "protein_coding") & (vepDf["Half_acids"] == checkDf["cv_half_aa"]) & (vepDf["Amino_acids"] != checkDf["cv_full_aa"]) & (vepDf["Protein_position"] == checkDf["cv_protein_position"])].drop_duplicates(subset = ["simple_name"])], ignore_index = True).drop_duplicates(subset = ["simple_name"]).reset_index(drop = True)
vepDf = vepDf[vepDf["simple_name"].isin(vepFinalDf["simple_name"]) == False]
checkDf = checkDf[checkDf["db_simple_name"].isin(vepFinalDf["simple_name"]) == False]
vepFinalDf = pd.concat([vepFinalDf, vepDf[((vepDf["IMPACT"] == "MODERATE") | (vepDf["IMPACT"] == "HIGH")) & (vepDf["BIOTYPE"] == "protein_coding") & (vepDf["Half_acids"] == checkDf["cv_half_aa"]) & (vepDf["Amino_acids"] != checkDf["cv_full_aa"]) & (vepDf["Protein_position"] == checkDf["cv_protein_position"])].drop_duplicates(subset = ["simple_name"])], ignore_index = True).drop_duplicates(subset = ["simple_name"]).reset_index(drop = True)
vepDf = vepDf[vepDf["simple_name"].isin(vepFinalDf["simple_name"]) == False]
checkDf = checkDf[checkDf["db_simple_name"].isin(vepFinalDf["simple_name"]) == False]
...
checkDfSave = checkDfSave[((checkDfSave["db_impact"] == "MODERATE") | (checkDfSave["db_impact"] == "HIGH")) & (checkDfSave["db_half_aa"] == checkDfSave["cv_half_aa"]) & (checkDfSave["db_full_aa"] != checkDfSave["cv_full_aa"]) & (checkDfSave["db_protein_position"] == checkDfSave["cv_protein_position"])]
...
combDf.to_csv("/net/data/aasubs/dbnsfp_catalog/filtered/moderate_filtered_potential_entries_full.csv")
