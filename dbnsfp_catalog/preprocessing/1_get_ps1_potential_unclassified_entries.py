...
if __name__ == "__main__":
	...
	cvDfFull.to_csv("/net/data/aasubs/dbnsfp_catalog/strong_cv_potential_entries.csv")
	dbDfFull.to_csv("/net/data/aasubs/dbnsfp_catalog/strong_db_potential_entries.csv")
