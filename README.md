...
_Note:_ Ensemble VEP is needed to retrieve annotations (with refseq option enabled and .txt output). The CADD and LOFTEE plugins for VEP are also used at various points. More information on these plugins can be found here: https://uswest.ensembl.org/info/docs/tools/vep/script/vep_plugins.html
